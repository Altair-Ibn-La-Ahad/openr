...
public class DocxFileTemplateBuilderTest {
    ...
    public void build() throws Exception {
        // given
        AbstractTemplateFileBuilder builder = new DocxFileTemplateBuilder(getTestFileName());
        // when
        builder.build();
        // then
        Assert.assertTrue(new File(getTestFileName() + ".docx").exists());
    }
