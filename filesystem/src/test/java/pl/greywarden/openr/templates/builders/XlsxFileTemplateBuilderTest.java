...
public class XlsxFileTemplateBuilderTest {
    ...
    public void build() throws Exception {
        // given
        AbstractTemplateFileBuilder builder = new XlsxFileTemplateBuilder(getTestFileName());
        // when
        builder.build();
        // then
        Assert.assertTrue(new File(getTestFileName() + ".xlsx").exists());
    }
