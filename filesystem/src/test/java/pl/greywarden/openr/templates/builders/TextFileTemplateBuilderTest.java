...
public class TextFileTemplateBuilderTest {
    ...
    public void build() throws Exception {
        // given
        AbstractTemplateFileBuilder builder = new TextFileTemplateBuilder(getTestFileName());
        // when
        builder.build();
        // then
        Assert.assertTrue(new File(getTestFileName() + ".txt").exists());
    }
