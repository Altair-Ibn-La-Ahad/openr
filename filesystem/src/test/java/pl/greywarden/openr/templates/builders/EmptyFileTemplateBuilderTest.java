...
public class EmptyFileTemplateBuilderTest {
    ...
    public void build() throws Exception {
        // given
        AbstractTemplateFileBuilder builder = new EmptyFileTemplateBuilder(getTestFileName());
        // when
        builder.build();
        // then
        Assert.assertTrue(new File(getTestFileName() + "").exists());
    }
