...
public class HtmlFileTemplateBuilderTest {
    ...
    public void build() throws Exception {
        // given
        AbstractTemplateFileBuilder builder = new HtmlFileTemplateBuilder(getTestFileName());
        // when
        builder.build();
        // then
        Assert.assertTrue(new File(getTestFileName() + ".html").exists());
    }
